...
export type TransformPluginAliasFileResolver = (params: {
  inputDir: AbsolutePath;
  filePath: RelativePath;
  finalOptions: TransformPluginAliasOptions;
  finalUserConfig: FinalUserConfig;
}) => MaybePromise<string>;
export type TransformPluginAliasOptions = {
  ...
  fileResolvers: Record<string, TransformPluginAliasFileResolver>;
  getFileResolver: (params: {
    inputDir: AbsolutePath;
    filePath: RelativePath;
    finalUserConfig: FinalUserConfig;
    finalOptions: TransformPluginAliasOptions;
  }) => MaybePromise<TransformPluginAliasFileResolver> | undefined;
};
export const DefaultTransformPluginAliasOptions: TransformPluginAliasOptions = {
  paths: {},
  pathResolver: (params) => {
...
export const TransformPluginAlias = (
  options?: Partial<TransformPluginAliasOptions>
) => {
  const finalOptions = mergeConfig(
    DefaultTransformPluginAliasOptions,
    options || {}
  );
